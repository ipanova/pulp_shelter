...
pulp-manager makemigrations shelter
pulp-manager migrate --noinput

# Run unit tests.
(cd ../pulp && coverage run manage.py test pulp_shelter.tests.unit)
...
pytest -v -r sx --color=yes --pyargs pulp_shelter.tests.functional || show_logs_and_return_non_zero
