...
The ``shelter`` plugin extends `pulpcore <https://pypi.python.org/pypi/pulpcore/>`__ to support
hosting shelter packages. This plugin is a part of the `Pulp Project
