...
Publishers contain extra settings for how to publish. You can use a shelter publisher on any
repository that contains shelter content::

$ http POST $BASE_ADDR/pulp/api/v3/publishers/shelter/ name=bar

Response::

    {
        "_href": "http://localhost:8000/pulp/api/v3/repositories/foo/publishers/shelter/bar/",
        ...
    }
...
$ http POST $BASE_ADDR/pulp/api/v3/publishers/shelter/1/publish/ repository=$BASE_ADDR/pulp/api/v3/repositories/1/
