...
from pulp_shelter.tests.functional.constants import SHELTER_PUBLISHER_PATH
from pulp_shelter.tests.functional.utils import gen_shelter_publisher, skip_if
...
class CRUDPublishersTestCase(unittest.TestCase):
    ...
    def test_01_create_publisher(self):
        """Create a publisher."""
        body = gen_shelter_publisher()
        type(self).publisher = self.client.post(SHELTER_PUBLISHER_PATH, body)
    ...
    def test_02_create_same_name(self):
        ...
        with self.assertRaises(HTTPError):
            self.client.post(SHELTER_PUBLISHER_PATH, body)
    ...
    def test_02_read_publishers(self):
        ...
        page = self.client.get(SHELTER_PUBLISHER_PATH, params={
