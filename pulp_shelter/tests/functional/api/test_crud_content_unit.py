# coding=utf-8
"""Tests that CRUD shelter content units."""
import unittest
...
class ContentUnitTestCase(unittest.TestCase):
    ...
    * `Pulp Smash #870 <https://github.com/PulpQE/pulp-smash/issues/870>`_
    ...
    def setUpClass(cls):
        ...
        files = {'file': utils.http_get(SHELTER_URL)}
    ...
    def test_01_create_content_unit(self):
        """Create content unit."""
        attrs = gen_shelter_content_attrs(self.artifact)
        self.content_unit.update(self.client.post(SHELTER_CONTENT_PATH, attrs))
    ...
    def test_02_read_content_units(self):
        ...
        page = self.client.get(SHELTER_CONTENT_PATH, params={
