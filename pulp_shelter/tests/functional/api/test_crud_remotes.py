# coding=utf-8
"""Tests that CRUD shelter remotes."""
...
from pulp_shelter.tests.functional.utils import skip_if, gen_shelter_remote
...
class CRUDRemotesTestCase(unittest.TestCase):
    ...
    def test_01_create_remote(self):
        ...
        type(self).remote = self.client.post(SHELTER_REMOTE_PATH, body)
    ...
    def test_02_create_same_name(self):
        ...
        with self.assertRaises(HTTPError):
            self.client.post(SHELTER_REMOTE_PATH, body)
    ...
    def test_02_read_remotes(self):
        ...
        page = self.client.get(SHELTER_REMOTE_PATH, params={
...
class CreateRemoteNoURLTestCase(unittest.TestCase):
    ...
    def test_all(self):
        ...
        * `Pulp Smash #984 <https://github.com/PulpQE/pulp-smash/issues/984>`_
        ...
        del body['url']
        with self.assertRaises(HTTPError):
            api.Client(config.get_config()).post(SHELTER_REMOTE_PATH, body)
